...
const defaultExecutor = async (_operation, action) => action();
export async function replaceFilesAtomically(replacements, options = {}) {
...
//# sourceMappingURL=file-transaction.js.map