...
export function ambiguousInspectionSqlError(hint) {
    return {
        ok: false,
        data: null,
        error: {
...
export function sqlTheEnginesLexDifferently(sql) {
...
export function readFirstSqlToken(sql) {
    return readBareSqlIdentifier(sql, skipSqlTrivia(sql, 0, true))?.value ?? null;
}
export function hasMultipleSqlStatements(sql) {
    const dialect = sqlDialectEveryEngineQuotes(true);
    let index = 0;
    while (index < sql.length) {
        const skipped = skipSqlQuotedOrCommented(sql, index, dialect);
...
export function isSafeInspectionPragma(sql, pragmaTokenLength) {
...
export function containsSideEffectSqlToken(sql) {
    return (containsSideEffectSqlTokenUnder(sql, true) || containsSideEffectSqlTokenUnder(sql, false));
}
export function containsSideEffectSqlTokenUnder(sql, lineCommentEndsAtCarriageReturn) {
...
export function readSqlTokens(sql, lineCommentEndsAtCarriageReturn) {
...
export function readBareSqlIdentifier(sql, index) {
...
export function readSqlTokenIdentifier(sql, index) {
...
// admitted.
export function readSqlQuotedIdentifier(sql, index, quotes) {
...
export function sqlDialectEveryEngineQuotes(lineCommentEndsAtCarriageReturn) {
    return {
        comments: true,
...
export function sqlDialectWithoutPostgresStringForms(lineCommentEndsAtCarriageReturn) {
    return {
        comments: true,
        lineCommentEndsAtCarriageReturn,
        dollarQuoting: false,
...
export function sqlDialectCommentsOnly(lineCommentEndsAtCarriageReturn) {
    return {
        comments: true,
        lineCommentEndsAtCarriageReturn,
        dollarQuoting: false,
...
export function sqlDialectQuotedIdentifiersOnly(quotes) {
    return {
        comments: false,
        lineCommentEndsAtCarriageReturn: true,
        dollarQuoting: false,
...
export function skipSqlQuotedOrCommented(sql, index, dialect) {
...
export function skipSqlTrivia(sql, startIndex, lineCommentEndsAtCarriageReturn) {
...
//# sourceMappingURL=inspection-sql.js.map