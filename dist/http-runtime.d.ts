...
export declare function routeConnectionToken(request: Pick<IncomingMessage, "method" | "url" | "headers" | "socket">, response: Pick<ServerResponse, "writeHead" | "end">, createConnectionToken: (currentToken?: string) => string): boolean;
