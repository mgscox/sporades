...
const MIGRATED_MODULE_STORAGE_SIGNATURE_SKEW_PROBE = [
    ["bucket-head", {
...
const MIGRATED_MODULE_STORAGE_PATH_SKEW_PROBE = [
...
const MIGRATED_MODULE_STORAGE_ENGINE_SKEW_PROBE = [
...
const MIGRATED_MODULE_MAYBE_PROMISE_SKEW_PROBE = [
    ["null", null],
    ["undefined", undefined],
    ["number", 7],
    ["plain-object", { a: 1 }],
