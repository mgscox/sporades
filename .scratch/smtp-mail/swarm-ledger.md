...
| 05 | re-review | 02, 03, 04 done | `630b589` | `codex/smtp-mail-05` / `/private/tmp/sporades-smtp-mail-swarm/issue-05` | `/root/smtp_05` | `ecee52c` | `/root/smtp_01_review` | pending; prior `93277c5`, `c2621e3`, and `07dda55` REQUEST_CHANGES and void | — | replacement SMTP 35 pass and types/docs 23 pass; typecheck/generated/docs/diff green | worktree clean; full-ticket review pending |
