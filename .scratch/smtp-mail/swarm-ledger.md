...
| 04 | re-review | 01 done | `f7e9916` | `codex/smtp-mail-04` / `/private/tmp/sporades-smtp-mail-swarm/issue-04` | `/root/smtp_04` | `d23ff4d` | `/root/smtp_01_review` | pending; prior `2acd395` REQUEST_CHANGES and void | — | replacement focused 25 pass; build/typecheck/generated/docs/diff green | worktree clean; full-ticket review pending |
| 05 | blocked | 02, 03, 04 | — | — | — | — | — | — | — | — | — |
