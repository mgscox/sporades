...
| 03 | rework | 01 done | `912a1ac` | `codex/smtp-mail-03` / `/private/tmp/sporades-smtp-mail-swarm/issue-03` | `/root/smtp_03` | `b913a04` | `/root/smtp_01_review` | REQUEST_CHANGES: long JSON token admitted then fails post-network; non-JSON whitespace corruption; prior `df0ef2d` also void | — | replacement focused 17 pass but independent probes exposed remaining boundary failures | worktree clean; second replacement required |
| 04 | ready | 01 done | — | — | — | — | — | — | — | — | — |
| 05 | blocked | 02, 03, 04 | — | — | — | — | — | — | — | — | — |
