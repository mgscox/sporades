...
| 03 | re-review | 01 done | `912a1ac` | `codex/smtp-mail-03` / `/private/tmp/sporades-smtp-mail-swarm/issue-03` | `/root/smtp_03` | `88bf341` | `/root/smtp_01_review` | pending; prior `df0ef2d` and `b913a04` REQUEST_CHANGES and void | — | second replacement focused 17 pass; build/generated parity green | worktree clean; full-ticket review pending |
| 04 | ready | 01 done | — | — | — | — | — | — | — | — | — |
| 05 | blocked | 02, 03, 04 | — | — | — | — | — | — | — | — | — |
