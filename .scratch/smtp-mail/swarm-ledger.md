...
| 03 | accepted | 01 done | `912a1ac` | `codex/smtp-mail-03` / `/private/tmp/sporades-smtp-mail-swarm/issue-03` | `/root/smtp_03` | `bbe1402` | `/root/smtp_01_review` | ACCEPT; prior `df0ef2d`, `b913a04`, and `88bf341` REQUEST_CHANGES and void | — | worker/reviewer focused 18 pass; build/generated parity green; adversarial boundary probes green | worktree clean; integration pending |
| 04 | ready | 01 done | — | — | — | — | — | — | — | — | — |
| 05 | blocked | 02, 03, 04 | — | — | — | — | — | — | — | — | — |
