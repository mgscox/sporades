...
| 04 | rework | 01 done | `f7e9916` | `codex/smtp-mail-04` / `/private/tmp/sporades-smtp-mail-swarm/issue-04` | `/root/smtp_04` | `2acd395` | `/root/smtp_01_review` | REQUEST_CHANGES: descriptor-unsafe config; case-sensitive X-*; Node 22.0-22.18 test incompatibility | — | focused 23 pass but adversarial/compatibility probes fail contract | worktree clean; replacement required |
| 05 | blocked | 02, 03, 04 | — | — | — | — | — | — | — | — | — |
