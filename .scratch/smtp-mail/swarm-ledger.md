...
| 05 | review | 02, 03, 04 done | `630b589` | `codex/smtp-mail-05` / `/private/tmp/sporades-smtp-mail-swarm/issue-05` | `/root/smtp_05` | `93277c5` | `/root/smtp_01_review` | pending | — | focused 53 pass; typecheck/generated/docs/diff green; broad 991 pass, 1 unrelated persistent Dev/Vite failure, 39 opt-in skip | worktree clean; review pending |
