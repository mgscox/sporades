...
| 04 | rework | 01 done | `f7e9916` | `codex/smtp-mail-04` / `/private/tmp/sporades-smtp-mail-swarm/issue-04` | `/root/smtp_04` | `d23ff4d` | `/root/smtp_01_review` | REQUEST_CHANGES: fail-closed default certificate verification not exercised on Node 22.0-22.18; prior `2acd395` void | — | replacement focused 25 pass but supported-version proof incomplete | worktree clean; second replacement required |
| 05 | blocked | 02, 03, 04 | — | — | — | — | — | — | — | — | — |
