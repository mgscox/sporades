...
| 03 | review | 01 done | `912a1ac` | `codex/smtp-mail-03` / `/private/tmp/sporades-smtp-mail-swarm/issue-03` | `/root/smtp_03` | `df0ef2d` | `/root/smtp_01_review` | pending | — | focused 16 pass; build/generated/docs green; broad run hit known infrastructure failures and Node 24 assertion before hanging | worktree clean; dependency symlink removed |
| 04 | ready | 01 done | — | — | — | — | — | — | — | — | — |
| 05 | blocked | 02, 03, 04 | — | — | — | — | — | — | — | — | — |
