...
| 04 | re-review | 01 done | `f7e9916` | `codex/smtp-mail-04` / `/private/tmp/sporades-smtp-mail-swarm/issue-04` | `/root/smtp_04` | `a9f698f` | `/root/smtp_01_review` | pending; prior `2acd395` and `d23ff4d` REQUEST_CHANGES and void | — | second replacement focused 26 pass; build/generated/diff green | worktree clean; full-ticket review pending |
| 05 | blocked | 02, 03, 04 | — | — | — | — | — | — | — | — | — |
