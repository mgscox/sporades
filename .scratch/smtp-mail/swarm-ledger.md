...
| 05 | rework | 02, 03, 04 done | `630b589` | `codex/smtp-mail-05` / `/private/tmp/sporades-smtp-mail-swarm/issue-05` | `/root/smtp_05` | `c2621e3` | `/root/smtp_01_review` | REQUEST_CHANGES: transport code accessor/proxy can leak; shutdown then close double-closes mail; prior `93277c5` void | — | focused 55 pass but adversarial error/lifecycle probes fail | worktree clean; second replacement required |
