...
| 03 | rework | 01 done | `912a1ac` | `codex/smtp-mail-03` / `/private/tmp/sporades-smtp-mail-swarm/issue-03` | `/root/smtp_03` | `88bf341` | `/root/smtp_01_review` | REQUEST_CHANGES: 997-token boundary includes punctuation; Unicode template whitespace mutates; prior SHAs void | — | focused 17 pass but boundary probes still fail contract | worktree clean; third replacement required |
| 04 | ready | 01 done | — | — | — | — | — | — | — | — | — |
| 05 | blocked | 02, 03, 04 | — | — | — | — | — | — | — | — | — |
