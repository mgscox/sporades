...
| 04 | review | 01 done | `f7e9916` | `codex/smtp-mail-04` / `/private/tmp/sporades-smtp-mail-swarm/issue-04` | `/root/smtp_04` | `2acd395` | `/root/smtp_01_review` | pending | — | focused 23 pass; typecheck/build/generated/docs/diff green; broad 983 pass, 1 unrelated Dev/Vite failure, 39 opt-in skip | worktree clean; review pending |
| 05 | blocked | 02, 03, 04 | — | — | — | — | — | — | — | — | — |
