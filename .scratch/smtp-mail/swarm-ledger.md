...
| 03 | rework | 01 done | `912a1ac` | `codex/smtp-mail-03` / `/private/tmp/sporades-smtp-mail-swarm/issue-03` | `/root/smtp_03` | `df0ef2d` | `/root/smtp_01_review` | REQUEST_CHANGES: JSON folding corruption/998-byte failure; STO range; Postmark-labelled Mailgun error | — | focused 16 pass but independent probes exposed criterion failures | worktree clean; replacement SHA required |
| 04 | ready | 01 done | — | — | — | — | — | — | — | — | — |
| 05 | blocked | 02, 03, 04 | — | — | — | — | — | — | — | — | — |
