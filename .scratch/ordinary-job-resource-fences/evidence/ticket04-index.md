...
| Job receipt | `04-red-pg-job-receipt.log`, `04-green-pg-job-receipt.log` | A real PostgreSQL-configured Job runs `ctx.resources.run`, commits one application write and one receipt. The red was PostgreSQL identifier quoting in the fixture, not a runtime regression. |
