...
- [ ] Claim and recovery use the enabled durable Schedule fingerprint as generation authority; an outgoing runtime cannot quarantine or overwrite a replacement-owned occurrence and stops its local superseded generation.
