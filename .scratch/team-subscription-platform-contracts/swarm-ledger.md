...
| 06 | done | 02, 04, 05 | `6c5e484` | `codex/team-contracts-06` / `/private/tmp/sporades-team-contracts-06` | `/root/ticket_06_combined_proof` | `fe9cb13` | `/root/last_review_ticket_04/ticket04_spec`, `/root/review_ticket_05_atomic_migration` | ACCEPT | `85d2266`..`4c44bf8` | integration: Job/Team/generated/PG 46/46; full candidate focused 258/258 and suite exit 0; typecheck/build/docs/generated-bin passed; main raw pack byte-identical SHA-256 `eb9846e9e70b196fad6fb1e3e3c740adee2445af61eefc92783b8d3e3fb057b6` | pending |
...
- Raw `npm pack --json --pack-destination /private/tmp/sporades-team-contracts-06-pack-fe9cb13` from `fe9cb13` produced `sporades-0.8.5.tgz` (241 files, 979206 bytes, 4963048 unpacked; SHA-256 `eb9846e9e70b196fad6fb1e3e3c740adee2445af61eefc92783b8d3e3fb057b6`). Direct extraction confirmed package version `0.8.5`, generated CLI and runtime implementation (including Job shutdown symbols), public source declarations for `PrivilegedTeamsApi`, `.unique`, and `insertOrIgnore`, plus README/CHANGES documentation. Canonical site documentation is intentionally outside the package's `files` allowlist and was separately built. This subsequent ledger-only evidence commit is excluded from the package `files` allowlist, so package bytes correspond exactly to `fe9cb13`.
