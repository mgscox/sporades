...
| 06 | review | 02, 04, 05 | `6c5e484` | `codex/team-contracts-06` / `/private/tmp/sporades-team-contracts-06` | `/root/ticket_06_combined_proof` | `fe9cb13` | `/root/last_review_ticket_04/ticket04_spec`, `/root/review_ticket_05_atomic_migration` | pending | pending | Node 22.23.2 focused 258/258; full suite exit 0; Node 24 Job lifecycle 7/7; typecheck/build/docs/generated-bin/diff passed; real PG guarded as `sporades_w17`/`sporades`; raw pack `/private/tmp/sporades-team-contracts-06-pack-fe9cb13/sporades-0.8.5.tgz` (241 files, 979206 bytes, SHA-256 `eb9846e9e70b196fad6fb1e3e3c740adee2445af61eefc92783b8d3e3fb057b6`) | pending |
