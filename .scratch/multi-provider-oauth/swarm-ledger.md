...
| 03 | review | None (02 done) | `c3da4ab` | `codex/multi-provider-oauth-03` / `/private/tmp/sporades-multi-provider-oauth-swarm/issue-03` | `/root/oauth_01` | `6f0035d` | `/root/oauth_01_review` | replacement review pending; prior `eb0de23` REQUEST_CHANGES void for replacement SHA | — | rework: create/client 96 pass; auth runtime 28 pass plus Apple; Sealed env 6 pass; Container 2 pass; docs 21 pass; type/build/generated/docs/diff green; full suite 976 pass, 38 skip, 1 known `/private/tmp` baseline fail | worker complete and clean; replacement review active |
| 04 | blocked | 02, 03 | — | — | — | — | — | — | — | — | — |
| 05 | blocked | 02, 03 | — | — | — | — | — | — | — | — | — |
| 06 | blocked | 02, 03 | — | — | — | — | — | — | — | — | — |
| 07 | blocked | 04, 05, 06 | — | — | — | — | — | — | — | — | — |
