...
| 04 | review | None (02, 03 done) | `1dc0371` | `codex/multi-provider-oauth-04` / `/private/tmp/sporades-multi-provider-oauth-swarm/issue-04` | `/root/oauth_04` | `e2669dc` | `/root/oauth_01_review` | replacement review pending; prior `e18fa3b` REQUEST_CHANGES void for replacement SHA | — | OAuth/create 58; adapter 70 pass, 1 Postgres opt-in skip; Dev 5; Container 1; Chrome 1; type/build/generated/docs/diff green | worker complete and clean; replacement review active |
| 05 | review | None (02, 03 done) | `1dc0371` | `codex/multi-provider-oauth-05` / `/private/tmp/sporades-multi-provider-oauth-swarm/issue-05` | `/root/oauth_05` | `84c7e09` | `/root/oauth_05_review` | replacement review pending; prior `a7b008d` REQUEST_CHANGES void for replacement SHA | — | provider 9; config/adapter/provider 125 pass, 0 fail, 1 Postgres opt-in skip; TLS/spoof Dev 2; Google Dev 1; Container 1; type/build/generated/docs/diff green | worker complete and clean; replacement review active |
| 06 | rework | None (02, 03 done) | `1dc0371` | `codex/multi-provider-oauth-06` / `/private/tmp/sporades-multi-provider-oauth-swarm/issue-06` | `/root/oauth_01` | `714af9c` | `/root/oauth_06_review` | REQUEST_CHANGES for `1dc0371...714af9c`: normalize omitted version to v23.0 consistently; preserve timeout taxonomy/cancel reader for stalled bodies | — | HTTPS/bounds/Chrome fixes verified; focused gates green | same worker second rework required; replacement SHA will void prior verdict |
| 07 | blocked | 04, 05, 06 | — | — | — | — | — | — | — | — | — |
