...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 05 | rework | 04 done | `af51482` | `codex/user-journey-05-replacement` / `/tmp/sporades-user-journey-swarm/issue-05` | `/root/journey_issue_05` | `4f12ae2` | `/root/journey_fix_02` | REQUEST_CHANGES: retired credential revives after restart | pending | prior focused 41/41 and full 599 pass insufficient; stale-after-restart regression required | pending |
