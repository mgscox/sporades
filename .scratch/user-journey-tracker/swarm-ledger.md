...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 05 | rework | 04 done | `af51482` | `codex/user-journey-05-replacement` / `/tmp/sporades-user-journey-swarm/issue-05` | `/root/journey_issue_05` | `604aaf4` | `/root/journey_fix_02` | REQUEST_CHANGES: retirement tombstones unbounded | pending | restart revival fixed; bounded admission/storage regression now required | pending |
