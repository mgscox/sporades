...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 05 | rework | 04 done | `e08e845` | `codex/user-journey-05-final` / `/tmp/sporades-user-journey-swarm/issue-05-final` | `/root/journey_05_final` | `70c6fa7` | `/root/journey_fix_02` | REQUEST_CHANGES: manual-only capture replacement lacks retirement owner | pending | prior diagnostics/transport gaps fixed; all-capture-false RED required | obsolete evidence branches retained |
