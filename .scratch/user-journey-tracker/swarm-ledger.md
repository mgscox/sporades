...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 05 | review | 04 done | `af51482` | `codex/user-journey-05-replacement` / `/tmp/sporades-user-journey-swarm/issue-05` | `/root/journey_issue_05` | `604aaf4` | `/root/journey_fix_02` | pending re-review; supersedes rejected `4f12ae2` | pending | RED retired credential revived after restart; focused 42/42; full 600 pass, 0 fail, 8 skipped; generated parity | pending |
