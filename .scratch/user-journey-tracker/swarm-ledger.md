...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 05 | rework | 04 done | `e08e845` | `codex/user-journey-05-final` / `/tmp/sporades-user-journey-swarm/issue-05-final` | `/root/journey_05_final` | `0a300c1` | `/root/journey_fix_02` | REQUEST_CHANGES: real pagehide retains state/consent | pending | reconnect fixed; pagehide immediate retirement RED required | obsolete evidence branches retained |
