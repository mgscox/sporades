...
export function createUserPreferencesTables(sqlite: LooseRecord) {
  return sqlite.exec(
    sqlite.dialect.sql(
...
export async function migrateAnonymousPreferences(database: LooseRecord, auth: LooseRecord, targetUserId: any, sqlite: LooseRecord | null = null) {
...
export async function readCurrentUserPreferences(database: LooseRecord, auth: LooseRecord) {
...
export function normalizePreferencesPatch(patch: any) {
