...
export function deserializeFieldValue(field: LooseRecord, value: any) {
...
export function deserializeRow(table: LooseRecord, row: LooseRecord) {
  const output = { ...row };
...
export function serializeFieldValue(field: LooseRecord, value: any) {
  if (value === undefined) {
    return null;
  }
  if (field?.kind === "Json") {
...
export function normalizeDateValue(value: string | number | Date, fieldName: string) {
