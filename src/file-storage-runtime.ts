...
export function s3ObjectKey(namespace: string, fileId: string, version: string | number) {
...
export function s3CanonicalPath(basePath: string, bucket: string, key: string | null) {
...
export function validatePublicUrlExpiry(options: LooseRecord) {
...
export function fileMetadataFromUpload(upload: LooseRecord) {
  return {
    id: upload.fileId,
...
export function normalizeFileName(name: any, filePath: string | null) {
