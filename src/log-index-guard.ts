...
export function targetsInternalLogIndexTable(sql: any) {
...
// exists for.
export function readSqlTableReference(sql: string, startIndex: number) {
...
export function isInternalLogIndexMetadataRow(row: Record<string, SQLOutputValue>, sql = "") {
