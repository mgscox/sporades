...
async function migrateAnonymousPreferences(database: LooseRecord, auth: LooseRecord, targetUserId: any) {
...
async function updateCurrentUserPreferences(database: LooseRecord, auth: LooseRecord, patch: any) {
  try {
