...
export function createLogIndexTables(sqlite: LooseRecord) {
...
export function insertLogIndexEvent(sqlite: LooseRecord, event: LooseRecord) {
...
export function pruneLogIndex(sqlite: LooseRecord, limit: any) {
...
export function readRecentLogEvents(sqlite: LooseRecord, limit = 200) {
