...
This page is the detailed reference for Sporades features and commands. For a
task-led path through the platform, start with the [user guide](../user-guide.md).

For the documentation split between conceptual guides, generated SDK reference,
and source comments, see [SDK documentation](../sdk-documentation.md).

This reference assumes you have installed `sporades` globally.
...
This page is exhaustive lookup material, not a tutorial to read from top to
bottom. Use the task pages in the sidebar for a guided workflow. Sections here
