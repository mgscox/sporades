...
Start with [queries, mutations, and auth state](./reference.md#building-the-client-side). Framework adapters bind that same transport to each admitted framework; they do not change the server contract.
