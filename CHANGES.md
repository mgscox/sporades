...
- Add user-defined templates spec and tracer-bullet tickets (4551f32).
- Add privileged file byte reads (4766559).
...
- Mark user-defined template tickets as done (f93950d).
...
- Document user-defined template feature across README, guides, PRD, and CONTEXT (2b6df3f).
- Bring mail and OAuth documentation up to date (e4b723b).
...
- Replace ignore npm dependency with inline gitignore matcher (adf137e).
- Fill in package.json npm metadata: description, keywords, repository, bugs, author (b0c5edc).
- Scaffold from a user-defined template directory (6518805).
