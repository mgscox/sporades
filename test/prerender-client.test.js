...
test('placement rejects content foster-parented outside its handover boundaries', () => {
  assert.throws(() => placeClientPrerenderFragments('<html><body><table><!-- sporades:prerender rows --><!-- author note --><tr id="author"><td>keep</td></tr></table></body></html>', [{name:'rows', html:'<tr><td>Static row</td></tr>'}]), /not stable in the parsed HTML document/i);
